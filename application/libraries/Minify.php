 ...
 * @link      Location: //github.com/slav123/CodeIgniter-Minify
 */
...
class Minify
{
	 ...
	 * @var string
	 */
	public $css_file = 'css/styles.css';
	...
	private function _closurecompiler($data)
	{
		...
		$ch = curl_init('//closure-compiler.appspot.com/compile');
