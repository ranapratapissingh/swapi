...
function build_url($protocol, $host, $base_path, $url) {
  ...
  if ( !in_array(mb_strtolower($protocol), array("//", "https://", "ftp://", "ftps://")) ) {
 ...
 * //msdn.microsoft.com/library/default.asp?url=/library/en-us/gdi/bitmaps_6x0u.asp
 *
 ...
 * see //msdn.microsoft.com/library/default.asp?url=/library/en-us/gdi/bitmaps_6x0u.asp
 *
 * @param string  $str   Data to decode
 * @param integer $width Image width
 *
 ...
 * //www.programmierer-forum.de/function-imagecreatefrombmp-welche-variante-laeuft-t143137.htm
 ...
 * @see //www.php.net/manual/en/function.set-error_handler.php
 *
 * @param int    $errno
 * @param string $errstr
 ...
 *
 * @link //us.php.net/manual/en/function.sys-get-temp-dir.php#85261
 */
