...
class Block_Frame_Reflower extends Frame_Reflower {
   ...
   *  //www.w3.org/TR/CSS21/visudet.html#Computing_widths_and_margins
   *  
   *  @param float $width
   *  @return array
   */
  ...
  protected function _calculate_restricted_height() {
    ...
    if ( $frame->is_absolute() ) {
      ...
      // see //www.w3.org/TR/CSS21/visudet.html#abs-non-replaced-height
   ...
   * //www.w3.org/TR/CSS21/text.html#propdef-text-align
   */
