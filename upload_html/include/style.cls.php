...
class Style {
   ...
   * //www.w3.org/TR/css3-fonts/#font-size-the-font-size-property
   * @var array<float>
   */
   ...
   *
   * @link //www.w3.org/TR/CSS21/propidx.html
   *
   * @var array
   */
   ...
   * actual font file.
   *
   * @link //www.w3.org/TR/CSS21/fonts.html#propdef-font-family
   * @throws DOMPDF_Exception
   *
   * @return string
   */
   ...
   *
   * @link //www.w3.org/TR/CSS21/fonts.html#propdef-font-size
   * @return float
   */
  ...
  /**
   * @link //www.w3.org/TR/CSS21/text.html#propdef-word-spacing
   * @return float
   */
  ...
  /**
   * @link //www.w3.org/TR/CSS21/text.html#propdef-letter-spacing
   * @return float
   */
  ...
  /**
   * @link //www.w3.org/TR/CSS21/visudet.html#propdef-line-height
   * @return float
   */
   ...
   *
   * @link //www.w3.org/TR/CSS21/colors.html#propdef-color
   * @return array
   */
  function get_color() {
   ...
   *
   * @link //www.w3.org/TR/CSS21/colors.html#propdef-background-color
   * @return array
   */
   ...
   *
   * @link //www.w3.org/TR/CSS21/colors.html#propdef-background-position
   * @return array
   */
   ...
   *
   * @link //www.w3.org/TR/CSS21/colors.html#propdef-background-attachment
   * @return string
   */
   ...
   * not used for further processing)
   *
   * @link //www.w3.org/TR/CSS21/colors.html#propdef-background-repeat
   * @return string
   */
   ...
   *
   * @link //www.w3.org/TR/CSS21/colors.html#propdef-background
   * @return string
   */
   ...
   *
   * @link //www.w3.org/TR/CSS21/box.html#border-color-properties
   * @return array
   */
 ...
 /**#@+
   ...
   *
   * @link //www.w3.org/TR/CSS21/box.html#border-width-properties
   * @return float|string
   */
   ...
   * e.g. "1px solid blue"
   *
   * @link //www.w3.org/TR/CSS21/box.html#border-shorthand-properties
   * @return string
   */
 ...
 /**#@+
   ...
   *
   * @link //www.w3.org/TR/CSS21/tables.html#propdef-border-spacing
   * @return array
   */
...
/*======================*/
   ...
   * @link     //www.w3.org/TR/CSS21/colors.html#background-properties
   *
   * @param string $val
   */
   ...
   *
   * @link //www.w3.org/TR/CSS21/generate.html#propdef-list-style
   * @param $val
   */
   ...
   *
   * @link //www.w3.org/TR/CSS21/page.html#page-breaks
   * @param string $break
   */
   ...
   *
   * @link //www.w3.org/TR/CSS21/box.html#margin-properties
   * @param $val
   */
   ...
   *
   * @link //www.w3.org/TR/CSS21/box.html#padding-properties
   * @param $val
   */
   ...
   *
   * @link //www.w3.org/TR/CSS21/box.html#border-properties
   * @param string $val
   */
   ...
   *
   * @link //www.w3.org/TR/CSS21/ui.html#dynamic-outlines
   * @param string $val
   */
   ...
   *
   * @link //www.w3.org/TR/CSS21/generate.html#propdef-list-style-image
   * @param $val
   */
  ...
  function set_list_style($val) {
    ...
    foreach ($arr as $value) {
      /* //www.w3.org/TR/CSS21/generate.html#list-style
   ...
   *
   * @link //www.w3.org/TR/css3-2d-transforms/#transform-property
   * @param string $val
   */
   ...
   *
   * @link //www.w3.org/TR/css3-2d-transforms/#transform-origin
   * @param string $val
   */
