 ...
 * //opensource.org/licenses/OSL-3.0
 ...
 * @copyright	Copyright (c) 2008 - 2012, EllisLab, Inc. (//ellislab.com/)
 * @license		//opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 ...
 * @category	Sessions
 * @author		EllisLab Dev Team
 * @link		//codeigniter.com/user_guide/libraries/sessions.html
 */
class CI_Session {
	...
	public function __construct($params = array())
	{
		...
		if ($this->sess_use_database === TRUE && $this->sess_table_name != '')
		{
			...
			$this->db = $this->CI->load->database('write_db', true);
		}
	...
	public function sess_update()
	{
		...
		if ($this->CI->input->is_ajax_request())
		{
			...
			if ($this->sess_use_database === TRUE)
			{
				...
				$this->db->query($this->db->update_string($this->sess_table_name,
