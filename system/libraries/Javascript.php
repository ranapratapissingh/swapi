 ...
 * @category	Javascript
 * @author		ExpressionEngine Dev Team
 * @link		//codeigniter.com/user_guide/libraries/javascript.html
 */
class CI_Javascript {
	...
	function external($external_file = '', $relative = FALSE)
	{
		...
		if ($relative === TRUE OR strncmp($external_file, '//', 7) == 0 OR strncmp($external_file, 'https://', 8) == 0)
		{
			$str = $this->_open_script($external_file);
		}
		elseif (strpos($this->_javascript_location, '//') !== FALSE)
		{
